...
import { Plus, Trash2, Shield, Award, RefreshCw, BookOpen, Edit, Download } from 'lucide-react';
    ...
    <div className="admin-panel-container fade-in">
      ...
      <div className="welcome-banner" style={{ marginTop: '8px', marginBottom: '16px' }}>
        <div>
          ...
          <h2 className="welcome-title">Manage Mock Papers</h2>
          <p className="welcome-subtitle">Create, publish, and sync exam test materials in real-time.</p>
        </div>
      </div>
